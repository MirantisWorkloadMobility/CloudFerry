...
class ReCreateBootImageTestCase(test.TestCase):
    ...
    @mock.patch('cloudferry.lib.utils.remote_runner.RemoteRunner',
                new=mock.Mock)
    @mock.patch('cloudferry.lib.utils.files.remote_file_size')
    @mock.patch('cloudferry.lib.utils.file_proxy.FileProxy')
    @mock.patch('cloudferry.lib.utils.files.RemoteStdout')
