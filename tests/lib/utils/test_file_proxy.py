...
class FileProxyTestCase(test.TestCase):
    def setUp(self):
        ...
        m = mock.patch('cloudferry.lib.utils.file_proxy.get_file_size')
        self.get_file_size = m.start()
        self.addCleanup(m.stop)
        m = mock.patch('cloudferry.lib.utils.file_proxy.SpeedLimiter')
        self.speed_limiter = m.start()
        self.addCleanup(m.stop)
        m = mock.patch('cloudferry.lib.utils.file_proxy.ProgressView')
...
class SpeedLimiterTestCase(test.TestCase):
    def setUp(self):
        ...
        m = mock.patch('cloudferry.lib.utils.sizeof_format.parse_size')
...
class ProgressViewTestCase(test.TestCase):
    def setUp(self):
        ...
        m = mock.patch('cloudferry.lib.utils.sizeof_format.sizeof_fmt')
    ...
    @mock.patch('cloudferry.lib.utils.sizeof_format.parse_size')
    ...
    @mock.patch('cloudferry.lib.utils.file_proxy.LOG.info')
