...
class NeutronTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.neutron_client_patch = mockpatch.PatchObject(neutron_client,
                                                          'Client',
        ...
        self.subnet_1_info = {'name': 'fake_subnet_name_1',
                              'id': 'fake_subnet_id_1',
                              'enable_dhcp': True,
                              'allocation_pools': [{'start': 'fake_start_ip_1', 'end': 'fake_end_ip_1'}],
        ...
        self.subnet_2_info = {'name': 'fake_subnet_name_2',
                              'id': 'fake_subnet_id_2',
                              'enable_dhcp': True,
                              'allocation_pools': [{'start': 'fake_start_ip_2', 'end': 'fake_end_ip_2'}],
    ...
    def test_get_client(self):
        ...
        self.neutron_mock_client.assert_called_once_with(username='fake_user',
                                                         password='fake_password',
    ...
    def test_get_networks(self):
        ...
        self.neutron_mock_client().list_networks.return_value = fake_networks_list
        self.neutron_mock_client().show_subnet.return_value = {'subnet':
                                                                   {'name': 'fake_subnet_name_1'}}
        self.neutron_network_client.get_resource_hash = mock.Mock(return_value='fake_net_hash_1')
    ...
    def test_get_subnets(self):
        ...
        fake_subnets_list = {'subnets': [{'name': 'fake_subnet_name_1',
                                          'enable_dhcp': True,
                                          'network_id': 'fake_network_id_1',
                                          'tenant_id': 'fake_tenant_id_1',
                                          'allocation_pools': [{'start': 'fake_start_ip_1', 'end': 'fake_end_ip_1'}],
        ...
        self.neutron_mock_client().list_subnets.return_value = fake_subnets_list
        self.neutron_mock_client().show_network.return_value = {'network':
                                                                    {'name': 'fake_network_name_1'}}
        self.neutron_network_client.get_resource_hash = mock.Mock(return_value='fake_subnet_hash_1')
    ...
    def test_get_routers(self):
        ...
        fake_routers_list = {'routers':
                                 [{'status': 'ACTIVE',
                                   'external_gateway_info':
                                       {'network_id': 'fake_network_id_1', 'enable_snat': True},
        ...
        self.neutron_mock_client().list_routers.return_value = fake_routers_list
        self.neutron_mock_client().show_network.return_value = {'network':
                                                                    {'name': 'fake_network_name_1',
                                                                     'tenant_id': 'fake_tenant_id_1'}}

        fake_ports_list = {'ports': [{'fixed_ips': [{'subnet_id': 'fake_subnet_id_1',
                                                     'ip_address': 'fake_ipaddr_1'}],
                                      'device_id': 'fake_router_id_1'}]}

        self.neutron_mock_client().list_ports.return_value = fake_ports_list
        self.neutron_network_client.get_resource_hash = mock.Mock(return_value='fake_router_hash')

        routers_info = [{'name': 'fake_router_name_1',
                         'id': 'fake_router_id_1',
                         'admin_state_up': True,
                         'routes': [],
                         'external_gateway_info': {'network_id': 'fake_network_id_1', 'enable_snat': True},
    ...
    def test_get_floatingips(self):
        ...
        fake_floatingips_list = {'floatingips': [{'router_id': None,
                                                'tenant_id': 'fake_tenant_id_1',
        ...
        self.neutron_mock_client().list_floatingips.return_value = fake_floatingips_list
        self.neutron_mock_client().show_network.return_value = {'network':
                                                                    {'name': 'fake_network_name_1',
                                                                     'tenant_id': 'fake_tenant_id_1'}}
    ...
    def test_get_security_groups(self):
        ...
        fake_secgroups_list = {'security_groups':
                                   [{'id': 'fake_secgr_id_1',
                                     'tenant_id': 'fake_tenant_id_1',
        ...
        self.neutron_mock_client().list_security_groups.return_value = fake_secgroups_list
        ...
        rule_info['rule_hash'] = self.neutron_network_client.get_resource_hash(rule_info,
                                                                               'direction',
                                                                               'remote_ip_prefix',
                                                                               'protocol',
                                                                               'port_range_min',
        ...
        secgr_info['res_hash'] = self.neutron_network_client.get_resource_hash(secgr_info,
                                                                               'name',
                                                                               'tenant_name',
                                                                               'description')
    ...
    def test_upload_neutron_security_groups(self):
        ...
        self.neutron_network_client.get_security_groups = mock.Mock(return_value=[sg1_info])

        fake_secgroups = [sg1_info, sg2_info]

        self.neutron_network_client.upload_neutron_security_groups(fake_secgroups)

        sec_gr_info = {'security_group': {'name': 'fake_secgr_name_2',
                                          'tenant_id': 'fake_tenant_id_1',
                                          'description': 'fake_secgr_2_description'}}

        self.neutron_mock_client().create_security_group.assert_called_once_with(sec_gr_info)
    ...
    def test_upload_sec_group_rules(self):
        ...
        existing_sg2_info = {'name': 'fake_secgr_name_2',
        ...
        self.neutron_network_client.get_security_groups = mock.Mock(return_value=fake_existing_secgroups)

        self.neutron_network_client.upload_sec_group_rules([sg1_info, sg2_info])

        rule_info = {'security_group_rule': {'direction': 'egress',
                                             'port_range_min': 80,
                                             'port_range_max': 80,
                                             'ethertype': 'IPv4',
                                             'remote_ip_prefix': None,
        ...
        self.neutron_mock_client().create_security_group_rule.assert_called_once_with(rule_info)

    def test_upload_networks(self):

        fake_existing_nets = [self.net_2_info]

        self.neutron_network_client.get_networks = mock.Mock(return_value=fake_existing_nets)

        network_info = {'network': {'name': 'fake_network_name_1',
                                        'admin_state_up': True,
                                        'tenant_id': 'fake_tenant_id_1',
                                        'shared': False}}
        ...
        self.neutron_mock_client().create_network.assert_called_once_with(network_info)
    ...
    def test_upload_subnets(self):
        ...
        self.neutron_network_client.get_networks = mock.Mock(return_value=[dst_net_info])
        self.neutron_network_client.get_subnets = mock.Mock(return_value=[{'res_hash': 'fake_subnet_hash_1'}])

        subnet_info = {'subnet': {'name': 'fake_subnet_name_2',
                                      'enable_dhcp': True,
                                      'network_id': 'fake_network_id_1',
                                      'cidr': 'fake_cidr_2',
                                      'allocation_pools': [{'start': 'fake_start_ip_2', 'end': 'fake_end_ip_2'}],
        ...
        self.neutron_network_client.upload_subnets([src_net_info], [subnet1_info, subnet2_info])
        self.neutron_mock_client().create_subnet.assert_called_once_with(subnet_info)

    def test_upload_routers(self):

        router1_info = {'name': 'fake_router_name_1',
                         'id': 'fake_router_id_1',
                         'admin_state_up': True,
                         'routes': [],
                         'external_gateway_info': {'network_id': 'fake_network_id_1', 'enable_snat': True},
        ...
        router2_info = {'name': 'fake_router_name_2',
                         'id': 'fake_router_id_2',
                         'admin_state_up': True,
                         'routes': [],
                         'external_gateway_info': {'network_id': 'fake_network_id_2', 'enable_snat': True},
        ...
        self.neutron_network_client.get_networks = mock.Mock(return_value=src_nets_info)
        self.neutron_network_client.get_subnets = mock.Mock(return_value=src_subnets_info)
        self.neutron_network_client.get_routers = mock.Mock(return_value=[router1_info])
        self.neutron_network_client.add_router_interfaces = mock.Mock(return_value=None)

        router_info = {'router': {'name': 'fake_router_name_2',
                                  'tenant_id': 'fake_tenant_id_2',
                                  'external_gateway_info': {'network_id': 'fake_network_id_2'}}}

        self.neutron_network_client.upload_routers(src_nets_info, src_subnets_info, src_routers_info)

        self.neutron_mock_client().create_router.assert_called_once_with(router_info)

    def test_add_router_interfaces(self):
        
        src_router = {'id': 'fake_router_id_1', 'subnet_ids': ['fake_subnet_id_1']}
        src_subnets = [{'id': 'fake_subnet_id_1', 'res_hash': 'fake_subnet_hash'}]
        dst_router = {'id': 'fake_router_id_2', 'subnet_ids': ['fake_subnet_id_2']}
        dst_subnets = [{'id': 'fake_subnet_id_2', 'res_hash': 'fake_subnet_hash'}]
        
        self.neutron_network_client.add_router_interfaces(src_router, dst_router, src_subnets, dst_subnets)

        self.neutron_mock_client().add_interface_router.assert_called_once_with('fake_router_id_2',
